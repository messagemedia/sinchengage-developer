...
| **Operation ID** | `createContactList` |
| **Authentication** | Basic Auth, HMAC Auth |
| **Success** | `201` — Contact list is created |
...
|--------|-------------|--------|
| 201 | Contact list is created | `ListData` |
...
```bash
curl -X POST "https://eu.app.api.sinch.com/api/v1/contacts/lists" \
...
```javascript
const response = await fetch("https://eu.app.api.sinch.com/api/v1/contacts/lists", {
  method: "POST",
  headers: {
