...
| **Operation ID** | `addContactToContactList` |
| **Authentication** | Basic Auth, HMAC Auth |
| **Success** | `200` — Contacts have been added |
...
| `contactId` | string (uuid) | Yes | Contact id to remove in UUID format |
...
|--------|-------------|--------|
| 200 | Contacts have been added | `ListData` |
| 201 | Created | `ListData` |
...
```bash
curl -X POST "https://eu.app.api.sinch.com/api/v1/contacts/lists/025e93d3-051b-43f9-b12e-4b5842228dee/contacts/4a03d2d8-1f85-463f-bdb4-2891c17258a7" \
