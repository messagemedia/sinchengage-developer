...
| **Operation ID** | `deleteCustomFieldById` |
| **Authentication** | Basic Auth, HMAC Auth |
| **Success** | `204` — Custom field is deleted |
...
```bash
curl -X DELETE "https://eu.app.api.sinch.com/api/v1/contacts/custom-fields/025e93d3-051b-43f9-b12e-4b5842228dee" \
