...
| **Operation ID** | `deleteContactListById` |
| **Authentication** | Basic Auth, HMAC Auth |
| **Success** | `204` — Contact list is deleted |
...
```bash
curl -X DELETE "https://eu.app.api.sinch.com/api/v1/contacts/lists/025e93d3-051b-43f9-b12e-4b5842228dee" \
