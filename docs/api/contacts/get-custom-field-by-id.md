...
| **Success** | `200` — Returns a single custom field |
...
|--------|-------------|--------|
| 200 | Returns a single custom field | `CustomFieldData` |
...
```bash
curl -X GET "https://eu.app.api.sinch.com/api/v1/contacts/custom-fields/025e93d3-051b-43f9-b12e-4b5842228dee" \
