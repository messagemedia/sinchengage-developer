...
| **Operation ID** | `updateContactList` |
| **Authentication** | Basic Auth, HMAC Auth |
| **Success** | `200` — List is updated |
...
| `alias` | string | No | Contact list alias |
...
```bash
curl -X PATCH "https://eu.app.api.sinch.com/api/v1/contacts/lists/025e93d3-051b-43f9-b12e-4b5842228dee" \
