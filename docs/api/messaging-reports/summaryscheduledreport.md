...
| **Method** | `POST` |
| **URL** | `https://eu.app.api.sinch.com/v2-preview/reporting/summary/scheduled` |
| **Operation ID** | `summaryscheduledreport` |
| **Authentication** | Basic Auth or HMAC Auth |
| **Success** | `201` — A scheduled summary report received using the specified parameters. |
...
|--------|-------------|--------|
| 201 | A scheduled summary report received using the specified parameters. | `scheduledreportresponse` |
...
```bash
curl -X POST "https://eu.app.api.sinch.com/v2-preview/reporting/summary/scheduled" \
...
```javascript
const response = await fetch("https://eu.app.api.sinch.com/v2-preview/reporting/summary/scheduled", {
  "method": "POST",
  "headers": {
