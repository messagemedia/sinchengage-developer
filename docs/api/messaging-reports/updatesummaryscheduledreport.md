...
| **Method** | `PUT` |
| **URL** | `https://eu.app.api.sinch.com/v2-preview/reporting/summary/scheduled/{id}` |
| **Operation ID** | `updatesummaryscheduledreport` |
| **Authentication** | Basic Auth or HMAC Auth |
| **Success** | `200` — The updated scheduled summary report. |
...
|------|------|----------|-------------|-------------|
| `id` | string | Yes | The ID of the scheduled report to update. |  |
...
|--------|-------------|--------|
| 200 | The updated scheduled summary report. | `scheduledsummaryreportresposne` |
| 400 | Bad Request | `400response` |
| 401 | Unauthorized | `403response` |

### 200 response schema (`scheduledsummaryreportresposne`)
...
```bash
curl -X PUT "https://eu.app.api.sinch.com/v2-preview/reporting/summary/scheduled/e6fb8282-c7c3-4367-8590-6c77ddb11c3e" \
...
```javascript
const response = await fetch("https://eu.app.api.sinch.com/v2-preview/reporting/summary/scheduled/e6fb8282-c7c3-4367-8590-6c77ddb11c3e", {
  "method": "PUT",
  "headers": {
