...
| **Method** | `PUT` |
| **URL** | `https://eu.app.api.sinch.com/v2-preview/reporting/detail/scheduled/{id}` |
| **Operation ID** | `updatedetailscheduledreport` |
| **Authentication** | Basic Auth or HMAC Auth |
| **Success** | `200` — The updated scheduled detail report. |
...
### updatescheduleddetailreport schema
...
|--------|-------------|--------|
| 200 | The updated scheduled detail report. | `scheduleddetailreportresponse` |
| 400 | Bad Request | `400response` |
| 401 | Unauthorized | `403response` |

### 200 response schema (`scheduleddetailreportresponse`)

| Property | Type | Required | Description | Constraints |
|----------|------|----------|-------------|-------------|
| `label` | string | No | The label of the report schedule |  |
| `schedule` | object | No | The time schedule of a scheduled report |  |
| `report` | object | No | A scheduled detail report request |  |
...
```bash
curl -X PUT "https://eu.app.api.sinch.com/v2-preview/reporting/detail/scheduled/e6fb8282-c7c3-4367-8590-6c77ddb11c3e" \
...
```javascript
const response = await fetch("https://eu.app.api.sinch.com/v2-preview/reporting/detail/scheduled/e6fb8282-c7c3-4367-8590-6c77ddb11c3e", {
  "method": "PUT",
  "headers": {
