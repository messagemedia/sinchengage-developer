...
(function () {
  ...
  var OP_TO_MD = {
    ...
    createcustomersubaccount: 'docs/api/account-management/create-customer-subaccount.md',
    ...
    createuserforaccount: 'docs/api/account-management/create-users-for-account.md',
    ...
    deletecustomeraccount: 'docs/api/account-management/delete-customer-account.md',
  ...
  var TAG_TO_MD = {
    ...
    'account-management': 'docs/api/account-management/index.md',
